...
public class telaGenio extends javax.swing.JFrame {
    ...
    public telaGenio() {
        initComponents();
        lblFrase.setText("<html>Adivinha um numero entre 1 e 5 ainda otario kk</html>");
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 130, 70));
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, -1, -1));

        btnPalpite.setFont(new java.awt.Font("Segoe UI", 2, 18)); // NOI18N
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 260, 100, 30));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        String f1 = "<html>Vc q é foda, acertou!</html>";
        String f2 = "<html>Erro otario! era o " + valor +"</html>";
